...
def tripDuration(df):
    ...
    average_duration = round(df['tripDuration'].mean())
    ...
    if display.lower() == 'yes':
        ...
        while display_more.lower() != 'no':
            ...
            while valid_input_2 == False:
                ...
                valid_input_2 = isValid(display_more)
...
def statistics():
    ...
    # 'end_station' for the use popularTrip() function
    ...
    if time_period == 'none':
        ...
        if time_period == 'month':
            filter_lower, filter_upper = getMonth()
        elif time_period == 'day':
            filter_lower, filter_upper = getDay()
    ...
    tripDuration(df_filtered)
    print("That took %s seconds." % (time.time() - start_time))
    print("\nCalculating the next statistic...")
    start_time = time.time()

    # What is the most popular start station and most popular end station?
    popularStations(df_filtered)
    print("That took %s seconds." % (time.time() - start_time))
    print("\nCalculating the next statistic...")
    start_time = time.time()

    # What is the most popular trip?
    popularTrip(df_filtered)
    print("That took %s seconds." % (time.time() - start_time))
    print("\nCalculating the next statistic...")
    start_time = time.time()
    ...
    if city == 'chicago.csv' or city == 'new_york_city.csv':
        ...
        birthYears(df_filtered)
        print("That took %s seconds." % (time.time() - start_time))

    # Display five lines of data at a time if user specifies that they would like to
    displayData(df_filtered)
